...
# from ..CLRerNet.lane_iou import LaneIoULoss
# from ..CLRerNet.assign import assign

class AUXCLRHead(nn.Module):
    def __init__(self,
                 num_points=72,
                 ...
                 sample_points=36,
                 cfg=None):
        super(AUXCLRHead, self).__init__()
        self.cfg = cfg
        ...
        # self.liou_loss = LaneIoULoss(img_h=self.img_h, img_w=self.cfg.ori_img_w)
    ...
    def loss(self,
        ...
        # liou_loss =  LaneIoULoss(img_h=self.img_h,img_w=self.cfg.ori_img_w)
        ...
        for stage in range(self.refine_layers):
            ...
            for predictions, target in zip(predictions_list, targets):
                ...
                iou_loss = iou_loss + liou_loss(
                    ...
                    self.img_w, length=15)[0]

                # iou_loss = iou_loss + self.liou_loss(
