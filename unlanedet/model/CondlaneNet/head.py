...
class CondaFocalLoss(nn.Module):
    ...
    def __init__(self,
        ...
        mask_branch.append(
            Conv2d(
                ...
                kernel_size=3,
                padding=1,
                norm=get_norm(norm=norm_cfg,out_channels=branch_channels)))
        ...
        mask_branch.append(
            Conv2d(
                ...
                kernel_size=3,
                padding=1,
                norm=get_norm(norm=norm_cfg,out_channels=branch_out_channels),
                activation=Activation(final_act_cfg)))
    ...
    def get_lanes(self, output):
        ...
        for seeds, hm in zip(out_seeds, out_hm):
            ...
            result = adjust_result(
                    ...
                    img_shape=(self.cfg.img_h, self.cfg.img_w),
