...
from .assign import assign # should change
from .lineiou_loss import liou_loss
from .a3d_sample import sampling_3d
...
from ...layers.ops import nms_srnet as nms
...
class CascadeRefineHead(nn.Module):
    ...
    def loss(self,
        ...
        attn_loss_weight = self.cfg.attn_loss_weight
        return_value = {"cls_loss": cls_loss * cls_loss_weight,
                        "l1_loss": l1_loss * l1_loss_weight,
                        "iou_loss": iou_loss * iou_loss_weight,
                        "attn_loss": attn_loss * attn_loss_weight}
