...
## What's New
* <font size=3> [2025-03-04] We release the Timm library wrapper! Users can directly transfer the advanced backbone to UnLanedet. In the following weeks, we will release the v2 version.
